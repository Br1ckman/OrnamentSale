  ...
  <ul>
   <li>
    <a href="product.jsp" class="goodsPic">
     <img src="../../upload/images/goods001.jpg"/>
    </a>
   ...
   <li>
    <a href="product.jsp" class="goodsPic">
     <img src="../../upload/images/goods002.jpg"/>
    </a>
    <div class="goodsInfor">
     <h2>
   ...
   <li>
    <a href="product.jsp" class="goodsPic">
     <img src="../../upload/images/goods003.jpg"/>
    </a>
    <div class="goodsInfor">
     <h2>
   ...
   <li>
    <a href="product.jsp" class="goodsPic">
     <img src="../../upload/images/goods005.jpg"/>
    </a>
    <div class="goodsInfor">
     <h2>
   ...
   <li>
    <a href="product.jsp" class="goodsPic">
     <img src="../../upload/images/goods004.jpg"/>
    </a>
    <div class="goodsInfor">
     <h2>
